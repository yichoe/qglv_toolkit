...
class KeyframeInterpolation : public QGLViewer
{
public :
  KeyframeInterpolation();
...
QString KeyframeInterpolation::helpString() const
{
...
void KeyframeInterpolation::keyPressEvent(QKeyEvent *e)
{
  switch (e->key())
        {
        case Qt::Key_Left :
...
void KeyframeInterpolation::draw()
{
